...
def forward_diffusion(
    ...
    sde, ones = diffusion_model.configure_sdes_forward(256, observation)

    for t in range(256):
        xt = sde.base_sde.sample(ones*t, observation)
