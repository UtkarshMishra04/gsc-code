...
class TableEnvDynamics(LatentDynamics):
    ...
    def forward_eval(
        ...
        # print("next_dynamics_state:", next_dynamics_state, next_dynamics_state.shape)

        # Update env state with new unnormalized observation.
        next_env_state = env_state.clone()
        next_dynamics_state = next_dynamics_state.reshape(-1, 8, 12)
        next_env_state[..., idx_args, :] = self._unnormalize_state(next_dynamics_state)

        # Set states of non existent object indices to 0
